...
async function dpOrder(id) {
  ...
  let html = `
    <div class="dp-section">
      ...
      <div class="dp-section-hd"><i data-lucide="package"></i> Order Information</div>
      <div class="dp-grid">
...
html += `
    <div class="dp-section">
      ...
      <div class="dp-action-row">
        ${isAdmin && canReceive ? `<button class="btn btn-green btn-sm" onclick="event.stopPropagation(); openReceive(${o.purchase_order_id})"><i data-lucide="package-check"></i> Receive Items</button>` : ''}
        ${isAdmin && canCancel ? `<button class="btn btn-red btn-sm" onclick="event.stopPropagation(); cancelOrder(${o.purchase_order_id})"><i data-lucide="x-circle"></i> Cancel Order</button>` : ''}
  ...
  if (status === 'CANCELLED') {
    html += `
      <div class="dp-alert danger">
        <i data-lucide="x-circle"></i> <span class="dp-alert-text">This order has been cancelled. No further actions available.</span>
      </div>
    `;
  }
